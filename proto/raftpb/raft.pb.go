...
type RequestVoteRequest struct {
	...
	IsPreVote     bool                   `protobuf:"varint,5,opt,name=is_pre_vote,json=isPreVote,proto3" json:"is_pre_vote,omitempty"`
...
func (x *RequestVoteRequest) GetIsPreVote() bool {
	if x != nil {
		return x.IsPreVote
	}
	return false
...
const file_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x10proto/raft.proto\x12\x04raft\"\xb5\x01\n" +
	...
	"\vis_pre_vote\x18\x05 \x01(\bR\tisPreVote\"L\n" +
	...
	"\rleader_commit\x18\x06 \x01(\x04R\fleaderCommit\"N\n" +
	"\bLogEntry\x12\x14\n" +
	"\x05index\x18\x01 \x01(\x04R\x05index\x12\x12\n" +
	"\x04term\x18\x02 \x01(\x04R\x04term\x12\x18\n" +
	"\acommand\x18\x03 \x01(\fR\acommand\"\x91\x01\n" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB3Z1github.com/yogeshwaran/bunkr/backend/proto/raftpbb\x06proto3"
